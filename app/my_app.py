...
def task():
    ...
    lst_image = ['BLUE_GREEN.png','BLUE.png','RED.png','YELLOW.png']

#     # なぜかうまくいかない ?????
#     lst_image = [os.path.basename(r) for r in glob('/templates/colors/*')]
#     lst_target = [r.split('Image/')[1] for r in glob('templates/Image/targets/*.png')]
    lst_target = ['targets/sketch_312_000291.png','targets/天下すえ_00013.png','targets/カウフマン母_由季江_00017.png','targets/ベリコフ_00002.png','targets/ヘンリー・オネガー_00009.png','targets/ヨーゼフ_00018.png','targets/sketch_168_000116.png','targets/sketch_276_000121.png',]

    reference1 = '/templates/Image_color/' + random.choice(lst_image)
    reference2 = '/templates/Image_color/' + random.choice(lst_image)
    while True:
...
#     target = random.choice(lst_target)
